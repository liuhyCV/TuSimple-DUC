...
def get_enet_symbol(num_classes, ohem=True, bn_momentum=0.9, spl=0):
    ...
    #body = mx.symbol.UpSampling(body, num_args=1, scale=4, sample_type='nearest', name='upsample')
    ...
    softmax = mx.symbol.SoftmaxOutput(data=body, multi_output=True, use_ignore=True, ignore_label=255,normalization='valid',
                                          name='seg_loss')  # is_hidden_layer=True,
